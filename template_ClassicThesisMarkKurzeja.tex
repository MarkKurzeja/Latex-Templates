...
% fonts around. Use it when you don't want the font to be noticed
% \usepackage{fontspec}
...
% 8) libertinus - the modern successor to Linux Libertine, a gorgeous open
% source font family with excellent math support. One of the best all-around
% choices with oldstyle figures, true small caps, and a matching sans-serif
