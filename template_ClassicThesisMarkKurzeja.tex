...
% it is only sensible that good sans-serifs and this fonts be included as well:
%\usepackage{kpfonts} % For default font that is excellent and very professional
%\usepackage[default]{sourcesanspro} % Very close to Myriad - favorite sans serif
%\usepackage[default,osfigures,scale=0.95]{opensans} % great sans serif with even color
%\usepackage{libertine} # replacement for times and gorgeous font
%\usepackage{alegreya} % Playful and professional - a great super family
